    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900 dark:text-white">Loading analysis data...</h3>
        ...
        <header className="bg-white dark:bg-gray-800 shadow">
          <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <nav className="flex space-x-4">
              ...
              <a href="/analysis/new" className="text-gray-500 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400">Analysis</a>
        ...
        <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
          <div className="px-4 py-6 sm:px-0">
            <div className="bg-red-50 dark:bg-red-900 p-4 rounded-md">
              <h3 className="text-lg font-medium text-red-800 dark:text-red-200">Error Loading Analysis</h3>
      ...
      <header className="bg-white dark:bg-gray-800 shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <nav className="flex space-x-4">
            <a href="/" className="text-gray-500 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400">Dashboard</a>
            <a href="/events" className="text-gray-500 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400">Events</a>
            <a href="/analysis/new" className="text-gray-900 dark:text-white font-medium hover:text-indigo-600 dark:hover:text-indigo-400">Analysis</a>
            <a href="/history" className="text-gray-500 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400">History</a>
            <a href="/settings" className="text-gray-500 dark:text-gray-300 hover:text-indigo-600 dark:hover:text-indigo-400">Settings</a>
          </nav>
        </div>
                ...
                <div className="lg:col-span-2">
                  <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
                    <div className="px-4 py-5 sm:px-6">
                      ...
                      <p className="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">
                        Generated on {new Date(analysis.timestamp || Date.now()).toLocaleDateString()}
                      </p>
                    </div>
                    
                    <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
                      <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Summary</h4>
                      <p className="text-sm text-gray-700 dark:text-gray-300">{analysis.insights?.summary || 'No summary provided.'}</p>
                    </div>
                    ...
                    <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-5 sm:px-6">
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        {analysis.insights?.additionalInsights || 'No additional insights provided.'}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 flex flex-col sm:flex-row sm:justify-between gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        onClick={() => alert('Analysis already saved to your history')}
                          ...
                          <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                            ...
                            <div className="mt-1">
                              {analysis.outcome === 'win' && (
                                <span className="px-2 py-1 text-sm rounded-full bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100">
                                  Win {analysis.roi && `(${analysis.roi})`}
                                </span>
                              )}
                              {analysis.outcome === 'loss' && (
                                <span className="px-2 py-1 text-sm rounded-full bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100">
                                  Loss {analysis.roi && `(${analysis.roi})`}
                                </span>
                              )}
                              {analysis.outcome === 'push' && (
                                <span className="px-2 py-1 text-sm rounded-full bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-100">
                                  Push
                                </span>
                              )}
                            </div>
